...
import com.SiYao.ForgeAPI.Resources.CustomResource;
import com.SiYao.ForgeAPI.Resources.CustomResourceManger;
import com.SiYao.ForgeAPI.Resources.CustomResourcePack;
...
public class MinecraftCore {
    ...
    public static void preinit(){
        //registerCustomModelLoder(new CustomModelLoader());
        registerCustomResourceManger(new CustomResourceManger());
    }
    ...
    public static void registerResource(ResourceLocation location, String absolutaPath, ResourceType type){
        CustomResourcePack.INSTANCE.resources.put(location,new CustomResource(location,absolutaPath));
    }
